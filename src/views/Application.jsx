...
export default function Application() {
  ...
  const title = "uber";
  const imageURL = "https://th.bing.com/th/id/OIP.7FzBf3Kxd0RtNloMTIsMPQHaHa?rs=1&pid=ImgDetMain";
    ...
    <section>
      <div className="flex gap-5 w-3/4 px-2 py-10  mx-auto">
        <div>
          ...
          />
          <a className=" px-1 py-1 text shadow-inner rounded-s" href={appURL}>
            Descargar
          </a>
        </div>
        <span>
