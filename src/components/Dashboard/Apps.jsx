   ...
   return <div className='bg-red-400 size-full'>
      ...
      <div className="grid my-4 mx-4 grid-cols-3 gap-8 justify-items-center text-gray-900">
         <div className="justify-items-center">
            ...
            <div>
            <div className="flex bg-orange-600 w-12 rounded-lg">
               <span className="text-lg text-white text-center w-full">8</span>
            </div>
            </div>
         </div>
         ...
         <div className="justify-items-center">
            ...
            <div>
            <div className="flex bg-orange-600 w-12 rounded-lg text-center">
               <span className="text-lg text-white text-center w-full">10</span>
            </div>
            </div>
         </div>
